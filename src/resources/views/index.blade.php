...
<div class="contact__content">
    ...
    <form action="/confirm" class="contact-form" method="post" novalidate>
            ...
            <div class="contact-form__group-content">
                <div class="contact-form__input--separate">
                    <div class="contact-form__name">
                        <input class="contact-form__name-input" type="text" name="first_name" placeholder="例: 山田" value="{{old('first_name', $contact['first_name'] ?? '')}}">
                    ...
                    <div class="contact-form__name">
                        <input class="contact-form__name-input" type="text" name="last_name" placeholder="例: 太郎" value="{{old('last_name', $contact['last_name'] ?? '')}}">
                        <div class="form__error">
                            @error('last_name')
                            {{$message}}
                            @enderror
        ...
        <div class="contact-form__group">
            ...
            <div class="contact-form__group-content">
                <div class="contact-form__input--gender">
                    <label><input class="contact-form__item--gender" type="radio" name="gender"  value="男性" {{old('gender', $contact['gender'] ?? '') == '男性' ? 'checked' : ''}} checked>男性</label>
                    <label><input type="radio" name="gender" class="contact-form__item--gender" value="女性" {{old('gender', $contact['gender'] ?? '') == '女性' ? 'checked' : ''}}>女性</label>
                    <label>
                        <input class="contact-form__item--gender" type="radio" name="gender" value="その他" {{old('gender', $contact['gender'] ?? '') == 'その他' ? 'checked' : ''}}>その他
                    </label>
                </div>
                <div class="form__error">
                    @error('gender')
        ...
        <div class="contact-form__group">
            ...
            <div class="contact-form__group-content">
                <div class="contact-form__input--separate">
                    <input class="contact-form__input-tel" type="text" name="tel[0]" placeholder="080" value="{{old('tel.0', $contact['tel'][0] ?? '')}}">
                    <span>-</span>
                    <input  class="contact-form__input-tel" type="text" name="tel[1]" placeholder="1234" value="{{old('tel.1', $contact['tel'][1] ?? '')}}">
                    <span>-</span>
                    <input class="contact-form__input-tel" type="text" name="tel[2]" placeholder="5678" value="{{old('tel.2', $contact['tel'][2] ?? '')}}">
                </div>
                <div class="form__error">
                    @error('tel.*')
                    {{$message}}
